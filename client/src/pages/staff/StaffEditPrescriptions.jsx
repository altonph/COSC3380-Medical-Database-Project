    ...
    const fetchPrescriptions = async () => {
      try {
        ...
        const response = await fetch(
          `https://cosc3380-medical-database-project-server.onrender.com/api/staff/patients/${patientID}/prescriptions`,
          {
            method: "GET",
            headers: {
...
export default StaffEditPrescriptions;