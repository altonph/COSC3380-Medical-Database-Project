...
const StaffPatientDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const patientPromise = fetch(`http://localhost:5000/api/staff/patients/${patientID}`, {
          method: 'GET',
          headers: {
        ...
        const medicalHistoryPromise = fetch(`http://localhost:5000/api/staff/patients/${patientID}/medical-history`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}` 
        ...
        const prescriptionsPromise = fetch(`http://localhost:5000/api/staff/patients/${patientID}/prescriptions`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}` 
        ...
        const billingHistoryPromise = fetch(`http://localhost:5000/api/staff/patients/${patientID}/invoices`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}` 
        ...
        const visitDetailsPromise = fetch(`http://localhost:5000/api/staff/patients/${patientID}/visit-details`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}` 
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1 flex">
        ...
        <main className="flex-1 p-4">
          ...
          <div className="mt-4">
              <Link to={`/staff/patients/${patientID}/visit-details`} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Edit Visit Details</Link>
            </div>
        </div>          
        ...
        <div className="mt-4">
          ...
          <div className="mt-8">
            ...
            {patientPrescriptions.length > 0 && (
              <div className="mt-4">
                <Link to={`/staff/patients/${patientID}/prescriptions`} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Edit Prescriptions</Link>
              </div>
            )}
          </div>
