...
const StaffAddMedicalHistory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    navigateTo(`/staff/patients/${patientID}/medical-history`);
  };
          ...
          <main className="flex-1 p-4">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-4">
                ...
                <Link to={`/staff/patients/${patientID}`} className="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 ml-2">Back to Patient {patientID}</Link>
              </div>
            </form>
          </main>
        </div>
...
export default StaffAddMedicalHistory;
